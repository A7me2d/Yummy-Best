...
{
    let hhh = ingredient.description.slice(0 , 100)
    return `
    <div class="col-xl-3 col-lg-4 col-md-6">
        <div class="ingredient-card shadow-none">
            <i class="fa-4x fa-solid fa-drumstick-bite text-light"></i>
            <h2 class="text-center fs-1 fw-light mt-2 fw-bold">${ingredient.name}</h2>
            <p class="text-center">${hhh}</p>
        </div>
    </div>`;
}
